    ...
    <section class="background-radial-gradient overflow-hidden">
        <div class="container-fluid">
            <div class="row flex-nowrap">
                <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color: rgb(5, 68, 104);">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li>
                                <a href="#" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                    <i class="bi bi-people-fill fs-4"></i> <span class="ms-1 d-none d-sm-inline">Mahasiswa</span> </a>
                            </li>
                        </ul>
                        <hr>
                ...
                <div class="col py-3 pt-5">
                    <div class="col-md">
                        <button class="btn btn-light btn-sm text-white border-0" style="font-weight: 600; background-color:darkgreen;" data-bs-toggle="modal" data-bs-target="#tambahData">
